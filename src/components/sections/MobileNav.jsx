    ...
    <div className='w-full h-[80px]  flex items-center  justify-between lg:hidden text-black px-5 '  onClick={toggleMenu}>
      ...
      >
        <button
          type='button'
          onClick={toggleMenu}
          className='mt-5 cursor-pointer font-mono flex items-center justify-center rounded-full bg-black text-white p-2 outline outline-1 outline-black'
        >
          close
        </button>

        <ul className='flex flex-col gap-8 font-mono text-md bg-white mt-20'>
          {TopNav.map((nav) => (
        ...
        <div className='w-full flex flex-col items-center text-sm gap-5 px-10 font-mono mt-20 '>
